...
class Advance_Spaceship(arcade.Sprite):
    def __init__(self ):
...
class Avanced_Bullet_1(arcade.Sprite):
    def __init__(self,host):
        super().__init__(':resources:images/space_shooter/laserRed01.png')
        self.center_x = host.center_x - 2
        self.center_y = host.center_y
        self.speed = 6
        self.angle = host.angle
...
class Avanced_Bullet_2(arcade.Sprite):
    def __init__(self,host):
        super().__init__(':resources:images/space_shooter/laserRed01.png')
        self.center_x = host.center_x + 2
        self.center_y = host.center_y
...
class Game(arcade.Window):
    def __init__(self):
        super().__init__(SCREEN_WIDTH, SCREEN_HEIGHT, title='Interstellar GAME !')
